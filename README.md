...
**FileManager — это мощный и интуитивно понятный консольный файловый менеджер, написанный на современном C++17. Он предоставляет полный набор инструментов для управления файловой системой прямо из командной строки.
